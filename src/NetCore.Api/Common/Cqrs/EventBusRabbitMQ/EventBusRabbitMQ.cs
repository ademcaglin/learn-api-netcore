using Autofac;
using NetCoreInfra.Common.Cqrs.EventBus;
...
namespace NetCoreInfra.Common.Cqrs.EventBusRabbitMQ
{
    ...
    {
        const string BROKER_NAME = "securityinfra_event_bus";

        private readonly IRabbitMQPersistentConnection _persistentConnection;
        private readonly ILogger<EventBusRabbitMQ> _logger;
        private readonly IEventBusSubscriptionsManager _subsManager;
        private readonly ILifetimeScope _autofac;
        private readonly string AUTOFAC_SCOPE_NAME = "securityinfra_event_bus";
